...
export const criarCampoTipoAtendimento = async (req, res) => {
    try {
        ...
        const newField = await CampoTipoAtendimento.create(req.body);
...
export const listarCamposTipoAtendimento = async (req, res) => {
    try {
        ...
        const fields = await CampoTipoAtendimento.findAll({
